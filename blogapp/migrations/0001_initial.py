    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Technology', 'Tecknology'), ('Economy', 'Economy'), ('Buisness', 'Buisness'), ('Lifestyle', 'Lifestyle'), ('Sport', 'Sport')], max_length=255, null=True)),
